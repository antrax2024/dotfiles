...
trayer --edge top --align right --transparent true --tint 0x000000 --SetDockType true --height 30 --distance 0 --margin 10 --widthtype request --SetPartialStrut true --expand true &
